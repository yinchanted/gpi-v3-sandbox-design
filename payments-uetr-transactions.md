...
- [ ] uetr (a list of uetrs)

> Scenario 1 - Returns events related to serial transaction

response: only if uetr in the request is "d2ecb184-b622-11e9-a2a3-2a2ae2dbcce4"

```json
{
  "payment_transaction_details_response": {
    "uetr": "d2ecb184-b622-11e9-a2a3-2a2ae2dbcce4",
    "transaction_status": {
      "status": "ACCC"
    },
...
> Scenario 2 - Returns events related to cover transaction

response: only if uetr in the request is "46ed4827-7b6f-4491-a06f-b548d5a7512d"
...
> Scenario 3 - Returns events related to serial transaction that went through a cancellation process

response: only if uetr in the request is "54ed4827-7b6f-4491-a06f-b548d5a7512d"
